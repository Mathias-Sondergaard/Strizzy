...
(function () {
  ...
  function render3DFeed() {
    ...
    debugBadge.style.cssText =
      "position:absolute;left:12px;top:12px;padding:6px 8px;background:rgba(0,0,0,0.45);color:#fff;border-radius:6px;font-size:12px;z-index:50;pointer-events:none";
